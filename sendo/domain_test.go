...
// HTTP behaviour is covered in sendo_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "sendo" {
		t.Errorf("Identity.Binary = %q, want sendo", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "sendo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("sendo", "about")
	if err != nil || got.String() != "sendo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want sendo://page/about", got.String(), err)
	}
}
