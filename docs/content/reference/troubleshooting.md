...
Most of these come down to network reality or how sendo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sendo rate-limits like any public site. sendo already paces
...
Where a surface is gated, sendo reads a cookie or token you supply
...
`sendo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sendo actually did
